    ...
    <div className='footerBox'>
      <div className='footerInfo'>
        <div className='upperInfo'>
          <h1 className='footerHeading'>let's work together</h1>

          <div className='upperRight'>
            <div className='URPara'>
        ...
        <div className='lowerInfo'>
          ...
          <div className='lowerRight'>
            <div className='lowerRightBlock'>
              <h3 className='LRHeading'>Address</h3>
              <div className='LRData'>
            ...
            <div className='lowerRightBlock'>
              <h3 className='LRHeading'>Call us on</h3>
              <div className='LRData'>
                <p>+1 98723 42023</p>
            ...
            <div className='lowerRightBlock'>
              <h3 className='LRHeading'>Our Policies</h3>
              <div className='LRData'>
                <p>Privacy Policy</p>
                <p>Terms of Use</p>
                <p>Refund Policy</p>
      ...
      <div className='footerLowerText'>
        <p className='lowerText'>Copyright © Webalar. All Rights Reserved</p>
      </div>
    </div>
  )
}